...
namespace Nez
{
	public class Scene
	{
		...
		public FastList<SceneComponent> _sceneComponents = new FastList<SceneComponent>();
		public FastList<Renderer> _renderers = new FastList<Renderer>();
		public FastList<Renderer> _afterPostProcessorRenderers = new FastList<Renderer>();
		public FastList<PostProcessor> _postProcessors = new FastList<PostProcessor>();
		bool _didSceneBegin;
